...
(0, mocha_1.describe)('PHPComposer', () => {
    (0, mocha_1.describe)('updateContent', () => {
        (0, mocha_1.it)('does not update a version when version is the same', async () => {
            ...
            (0, chai_1.expect)(newContent).to.eq('{"version":"1.0.0","replace":{"my/package":"1.0.0"}}');
            snapshot(newContent);
        });
        ...
        (0, mocha_1.it)('update replace package in composer.json when package is set in version map', async () => {
            ...
            (0, chai_1.expect)(newContent).to.eq('{"replace":{"my/package":"1.0.0"}}');
            snapshot(newContent);
        });
        (0, mocha_1.it)('update replace package in composer.json when package is missing', async () => {
