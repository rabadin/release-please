...
(0, mocha_1.describe)('PackageLockJson', () => {
    ...
    (0, mocha_1.describe)('updateContent v3 monorepo', () => {
        (0, mocha_1.it)('updates the package version', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './package-lock-v3-workspace.json'), 'utf8');
            const versionsMap = new Map();
            versionsMap.set('release-please-foo', new version_1.Version(2, 0, 0));
            versionsMap.set('release-please-bar', new version_1.Version(3, 0, 0));
            const packageJson = new package_lock_json_1.PackageLockJson({
                version: version_1.Version.parse('14.0.0'),
                versionsMap,
            });
