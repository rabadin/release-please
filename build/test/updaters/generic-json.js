...
(0, mocha_1.describe)('GenericJson', () => {
    (0, mocha_1.describe)('updateContent', () => {
        ...
        (0, mocha_1.it)('updates substring in matching entry', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './renovate-shared-preset.json'), 'utf8').replace(/\r\n/g, '\n');
            const updater = new generic_json_1.GenericJson('$.extends.*', version_1.Version.parse('v2.3.4'));
            const newContent = updater.updateContent(oldContent);
            snapshot(newContent);
        });
        ...
        (0, mocha_1.it)('ignore array entry', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './renovate-shared-preset.json'), 'utf8').replace(/\r\n/g, '\n');
            const updater = new generic_json_1.GenericJson('$.extends', version_1.Version.parse('v2.3.4'));
            const newContent = updater.updateContent(oldContent);
            (0, chai_1.expect)(newContent).to.eql(oldContent);
        });
        (0, mocha_1.it)('ignore non-matching string', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './esy.json'), 'utf8').replace(/\r\n/g, '\n');
            const updater = new generic_json_1.GenericJson('$.author', version_1.Version.parse('v2.3.4'));
            const newContent = updater.updateContent(oldContent);
            (0, chai_1.expect)(newContent).to.eql(oldContent);
        });
    });
