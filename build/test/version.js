...
(0, mocha_1.describe)('Version', () => {
    ...
    (0, mocha_1.describe)('isPreMajor', () => {
        (0, mocha_1.it)('should return true for versions < 1.0.0', () => {
            (0, chai_1.expect)(version_1.Version.parse('0.1.0').isPreMajor).to.be.true;
        });
        (0, mocha_1.it)('should return false for versions >= 1.0.0', () => {
            (0, chai_1.expect)(version_1.Version.parse('1.0.0').isPreMajor).to.be.false;
        });
    });
});
