 ...
 * does not exist.
 */
function readFixture(fixturesPath, fixture) {
    const file = (0, path_1.resolve)(fixturesPath, fixture);
    if (!(0, fs_1.existsSync)(file)) {
        return '';
    }
    return (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, fixture), 'utf8');
}
