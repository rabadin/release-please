...
(0, mocha_1.describe)('GitHub', () => {
    ...
    (0, mocha_1.describe)('buildChangeSet', () => {
        (0, mocha_1.it)('should merge updates for the same file', async () => {
            ...
            const updates = [
                {
                    ...
                    updater: new release_please_manifest_1.ReleasePleaseManifest({
                        ...
                        versionsMap: new Map([['path1', version_1.Version.parse('1.1.0')]]),
                    }),
                },
                {
                    path: manifestPath,
            ...
            const changes = await github.buildChangeSet(updates, 'main');
            (0, chai_1.expect)(changes).to.not.be.undefined;
            (0, chai_1.expect)(changes.size).to.eql(1);
            ...
            (0, chai_1.expect)(updatedContent).to.eql(expectedContent);
        });
    });
