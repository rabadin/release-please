...
(0, mocha_1.describe)('Manifest', () => {
    ...
    (0, mocha_1.describe)('fromManifest', () => {
        ...
        (0, mocha_1.it)('should override releasedVersions with latestTagVersion', async () => {
            const getFileContentsStub = sandbox.stub(github, 'getFileContentsOnBranch');
            getFileContentsStub
                .withArgs('release-please-config.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileContent)(fixturesPath, 'manifest/config/simple.json'))
                .withArgs('.release-please-manifest.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileRaw)('{".":" 0.0.0"}'));
            const manifest = await manifest_1.Manifest.fromManifest(github, github.repository.defaultBranch, undefined, undefined, { latestTagVersion: '1.2.3' });
            (0, chai_1.expect)(manifest.releasedVersions['.']).to.not.be.undefined;
            (0, chai_1.expect)(manifest.releasedVersions['.'].toString()).to.eql('1.2.3');
        });
        (0, mocha_1.it)('should override releasedVersions for specific path with latestTagVersion', async () => {
            const getFileContentsStub = sandbox.stub(github, 'getFileContentsOnBranch');
            getFileContentsStub
                .withArgs('release-please-config.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileContent)(fixturesPath, 'manifest/config/config.json'))
                .withArgs('.release-please-manifest.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileContent)(fixturesPath, 'manifest/versions/versions.json'));
            const manifest = await manifest_1.Manifest.fromManifest(github, github.repository.defaultBranch, undefined, undefined, { latestTagVersion: '5.0.0' }, 'packages/gcf-utils');
            (0, chai_1.expect)(manifest.releasedVersions['packages/gcf-utils']).to.not.be
                .undefined;
            (0, chai_1.expect)(manifest.releasedVersions['packages/gcf-utils'].toString()).to.eql('5.0.0');
        });
    });
    (0, mocha_1.describe)('fromConfig', () => {
        ...
        (0, mocha_1.it)('should use latestTagVersion from manifestOptions if provided', async () => {
            ...
            (0, chai_1.expect)(Object.keys(manifest.repositoryConfig)).lengthOf(1);
            (0, chai_1.expect)(Object.keys(manifest.releasedVersions)).lengthOf(1);
            (0, chai_1.expect)(manifest.releasedVersions['.'].toString()).to.equal('2.3.4');
        });
    });
    (0, mocha_1.describe)('buildPullRequests', () => {
        ...
        (0, mocha_1.it)('should allow customizing pull request title with root package with SPACE in component', async () => {
            (0, helpers_1.mockReleases)(sandbox, github, [
                {
                    id: 1,
                    sha: 'abc123',
        ...
        (0, mocha_1.it)('should allow customizing pull request title with root package without SPACE in component', async () => {
            (0, helpers_1.mockReleases)(sandbox, github, [
                {
                    id: 1,
                    sha: 'abc123',
        ...
        (0, mocha_1.it)('should allow customizing pull request title without root package with space', async () => {
            (0, helpers_1.mockReleases)(sandbox, github, [
                {
                    id: 1,
                    sha: 'abc123',
        ...
        (0, mocha_1.it)('should allow customizing pull request title without root package without space', async () => {
            (0, helpers_1.mockReleases)(sandbox, github, [
                {
                    id: 1,
                    sha: 'abc123',
    ...
    (0, mocha_1.describe)('createPullRequests', () => {
        ...
        (0, mocha_1.describe)('with an overflowing body', () => {
            ...
            (0, mocha_1.it)('updates an existing pull request without changes if set to always update', async function () {
                sandbox
                    .stub(github, 'getFileContentsOnBranch')
                    .withArgs('README.md', 'main')
                    .resolves((0, helpers_1.buildGitHubFileRaw)('some-content'))
    ...
    (0, mocha_1.describe)('createReleases', () => {
        (0, mocha_1.it)('should handle a single manifest release', async () => {
            ...
            (0, chai_1.expect)(releases[0].path).to.eql('.');
            (0, chai_1.expect)(releases[0].prNumber).to.eql(1234);
