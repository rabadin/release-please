...
(0, mocha_1.describe)('Strategy', () => {
    ...
    (0, mocha_1.describe)('buildRelease', () => {
        ...
        (0, mocha_1.it)('skips v in release name', async () => {
            const strategy = new TestStrategy({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
            ...
            (0, chai_1.expect)(release, 'Release').to.not.be.undefined;
            (0, chai_1.expect)(release.name).to.eql('1.2.3');
        });
        (0, mocha_1.it)('skips v in release name with component', async () => {
            const strategy = new TestStrategy({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
            ...
            (0, chai_1.expect)(release, 'Release').to.not.be.undefined;
            (0, chai_1.expect)(release.name).to.eql('google-cloud-automl: 1.2.3');
        });
        (0, mocha_1.it)('includes v in release name by default', async () => {
            const strategy = new TestStrategy({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
            ...
            (0, chai_1.expect)(release, 'Release').to.not.be.undefined;
            (0, chai_1.expect)(release.name).to.eql('v1.2.3');
        });
    });
});
