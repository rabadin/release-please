...
(0, mocha_1.describe)('Go', () => {
    ...
    (0, mocha_1.describe)('buildUpdates', () => {
        (0, mocha_1.it)('builds common files', async () => {
            ...
            (0, helpers_1.assertNoHasUpdate)(updates, 'internal/version/version.go');
        });
        (0, mocha_1.it)('updates version file when version-file is set', async () => {
            const strategy = new go_1.Go({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
            ...
            const updates = release.updates;
            (0, helpers_1.assertHasUpdate)(updates, 'CHANGELOG.md', changelog_1.Changelog);
            (0, helpers_1.assertHasUpdate)(updates, 'internal/version/version.go', version_go_1.VersionGo);
        });
        (0, mocha_1.it)('omits changelog if requested', async () => {
            const strategy = new go_1.Go({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
