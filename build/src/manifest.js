...
class Manifest {
    ...
    static async fromManifest(github, targetBranch, configFile = exports.DEFAULT_RELEASE_PLEASE_CONFIG, manifestFile = exports.DEFAULT_RELEASE_PLEASE_MANIFEST, manifestOptionOverrides = {}, path, releaseAs) {
        ...
        if (manifestOptionOverrides === null || manifestOptionOverrides === void 0 ? void 0 : manifestOptionOverrides.latestTagVersion) {
            const targetPath = path || exports.ROOT_PROJECT_PATH;
            releasedVersions[targetPath] = version_1.Version.parse(manifestOptionOverrides.latestTagVersion);
        }
    ...
    static async fromConfig(github, targetBranch, config, manifestOptions, path = exports.ROOT_PROJECT_PATH) {
        ...
        let latestVersion;
        if (manifestOptions === null || manifestOptions === void 0 ? void 0 : manifestOptions.latestTagVersion) {
            latestVersion = version_1.Version.parse(manifestOptions.latestTagVersion);
        }
        else {
            latestVersion = await latestReleaseVersion(github, targetBranch, version => isPublishedVersion(strategy, version), config, component, manifestOptions === null || manifestOptions === void 0 ? void 0 : manifestOptions.logger);
        }
        if (latestVersion) {
...
function mergeReleaserConfig(defaultConfig, pathConfig) {
    ...
    return {
        ...
        includeVInReleaseName: (_y = pathConfig.includeVInReleaseName) !== null && _y !== void 0 ? _y : defaultConfig.includeVInReleaseName,
        tagSeparator: (_z = pathConfig.tagSeparator) !== null && _z !== void 0 ? _z : defaultConfig.tagSeparator,
        pullRequestTitlePattern: (_0 = pathConfig.pullRequestTitlePattern) !== null && _0 !== void 0 ? _0 : defaultConfig.pullRequestTitlePattern,
        pullRequestHeader: (_1 = pathConfig.pullRequestHeader) !== null && _1 !== void 0 ? _1 : defaultConfig.pullRequestHeader,
        pullRequestFooter: (_2 = pathConfig.pullRequestFooter) !== null && _2 !== void 0 ? _2 : defaultConfig.pullRequestFooter,
        componentNoSpace: (_3 = pathConfig.componentNoSpace) !== null && _3 !== void 0 ? _3 : defaultConfig.componentNoSpace,
        separatePullRequests: (_4 = pathConfig.separatePullRequests) !== null && _4 !== void 0 ? _4 : defaultConfig.separatePullRequests,
        skipSnapshot: (_5 = pathConfig.skipSnapshot) !== null && _5 !== void 0 ? _5 : defaultConfig.skipSnapshot,
        initialVersion: (_6 = pathConfig.initialVersion) !== null && _6 !== void 0 ? _6 : defaultConfig.initialVersion,
        extraLabels: (_7 = pathConfig.extraLabels) !== null && _7 !== void 0 ? _7 : defaultConfig.extraLabels,
        excludePaths: (_8 = pathConfig.excludePaths) !== null && _8 !== void 0 ? _8 : defaultConfig.excludePaths,
